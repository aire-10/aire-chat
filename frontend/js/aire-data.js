...
const AireData = (() => {
  ...
  const STAGES = {
    egg:         { label: "Egg",         img: "../images/butterfly/egg.png"            },
    pupa:        { label: "Pupa",        img: "../images/butterfly/pupa.png"           },
    caterpillar: { label: "Caterpillar", img: "../images/butterfly/catepillar.png"     },
    butterfly:   { label: "Butterfly",   img: "../images/butterfly/daisybutterfly.png" },
  ...
  function load(key, fallback) {
    try {
      const custom = typeof StorageDB !== 'undefined' ? StorageDB.getAppData(key) : null;
  ...
  function save(key, val) {
    if (typeof StorageDB !== 'undefined') StorageDB.setAppData(key, val);
